...
export class AdminLayoutComponent implements OnInit {
  ...
  constructor( public location: Location, private router: Router,
    private adminLayoutService:AdminLayoutService, private snackBar:MatSnackBar,
    private msalUserService:MsalUserService) {}

  ngOnInit() {
    this.msalUserService.getLoggedUser()
    .subscribe(
      (response: any) => {
  ...
  askMentor(sendQuery:FormGroup)
  {
      if(sendQuery.value.query != undefined && sendQuery.value.query != '')
      {
        ...
        this.adminLayoutService.sendQuery(this.query)
        .subscribe(
            (response: any) => {
                this.saveQuery.reset();
                this.snackBar.open("Your query has been sent.","", {
